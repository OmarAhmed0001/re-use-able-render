...
// @route   GET /api/v1/......
// @access  Public
const getAllItems = (Model, populate = [""], fields = "-__v") => (0, express_async_handler_1.default)(async (req, res, next) => {
    var _a, _b;
    //  1- find all data
    ...
    if (query && (query.category || query.subcategory)) {
        categoryMeta = await meta_model_1.Meta.findOne({ reference: query.category });
        subcategoryMeta = await meta_model_1.Meta.findOne({ reference: query.subcategory });
    }
    let MetaData = {
        categoryMeta,
        subcategoryMeta,
...
// @route   GET /api/v1/......
// @access  Public
const getOneItemById = (Model, populate = [""], fields = "-__v") => (0, express_async_handler_1.default)(async (req, res, next) => {
