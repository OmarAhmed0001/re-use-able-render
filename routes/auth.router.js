...
authRoute.route("/register").post((0, validation_middleware_1.validate)(auth_validator_1.userRegisterValidation), auth_controller_1.register);
authRoute.route("/login").post((0, validation_middleware_1.validate)(auth_validator_1.userLoginValidation), auth_controller_1.login);
authRoute.route("/verifyCode").post((0, validation_middleware_1.validate)(auth_validator_1.verifyCodeValidation), auth_controller_1.verifyCode);
authRoute.route("/createGuestUser").post(auth_controller_1.createGuestUser);
authRoute
