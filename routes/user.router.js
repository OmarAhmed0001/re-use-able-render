...
userRouter
    .route("/:id/addRole")
    .put(protected_middleware_1.protectedMiddleware, (0, allowedTo_middleware_1.allowedTo)(user_interface_1.Role.RootAdmin, user_interface_1.Role.AdminA), (0, validation_middleware_1.validate)(user_validation_1.addRoleValidationSchema), user_controller_1.addRole);
userRouter
